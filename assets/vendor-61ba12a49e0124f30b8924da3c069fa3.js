...
function t(){var e=Object.create(null)
return e._dict=null,delete e._dict,e}Object.defineProperty(e,"__esModule",{value:!0}),e.default=t}),define("sample_addon/components/x-button/component",["exports","sample_addon/components/x-button/template"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default,tagName:"button",classNames:["btn"],classNameBindings:["btnTypeClass"],attributeBindings:["isDisabled:disabled","type","title"],buttonType:"default",btnTypeClass:Ember.computed("buttonType",function(){return"btn-"+(this.get("buttonType")||"default")})})}),define("sample_addon/components/x-button/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"xmKf9X6D",block:'{"symbols":["&default"],"statements":[[11,1]],"hasEval":false}',meta:{moduleName:"sample_addon/components/x-button/template.hbs"}})})
